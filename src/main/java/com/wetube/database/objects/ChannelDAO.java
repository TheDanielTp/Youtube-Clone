...
public class ChannelDAO
{
    ...
    //region [ - Channel Creation & Update Methods - ]
...
//        String    channelPicture = getRandomChannelPicture ();
        ...
        try (Connection connection = connection (); PreparedStatement preparedStatement = connection.prepareStatement (query))
        {
            ...
            preparedStatement.setInt (5, subscribers);
            preparedStatement.setInt (6, totalVideos);
            preparedStatement.setInt (7, totalViews);
            preparedStatement.setInt (8, watchTime);
            preparedStatement.setObject (9, creationDate);
            preparedStatement.setBoolean (10, isVerified);
            preparedStatement.setDouble (11, outcome);
//            preparedStatement.setString (12, channelPicture);
    ...
    public static ServerResponse changeName (int requestID, UUID userID, String name)
    {
        System.out.println ("> Database: Changing name to " + name + " ...");
