...
//        hbxVideoRecommendation.getStylesheets().add(Objects.requireNonNull(getClass().getResource("/Styles/" + MainApplication.DarkTheme + "/video-recommendation.css")).toExternalForm());
//    }
//
