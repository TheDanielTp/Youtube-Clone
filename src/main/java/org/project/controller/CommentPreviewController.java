...
public class CommentPreviewController implements Initializable
{
    ...
    public void setComment (Comment comment)
    {
        ...
        txtLikes.setText (String.valueOf (comment.getLikesCount ()));

        //region [ - Time - ]
        LocalDateTime localDateTime = comment.getCreationDate ();
    ...
    private void updateLike (ActionEvent event)
    {
        ...
        Object[] likeResponse = MainApplication.client.like (comment, MainApplication.currentUser);
    }
    //endregion
    ...
    private void updateDislike (ActionEvent event)
    {
        ...
        Object[] dislikeResponse = MainApplication.client.dislike (comment, MainApplication.currentUser);
    }
    //endregion
    //endregion
