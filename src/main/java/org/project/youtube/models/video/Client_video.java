...
import org.project.youtube.database.objects.PostDAO;
...
public class Client_video
{
    ...
    public void like (UUID video_id, UUID user_id, int request_id)
    {
        video.setRequest ("like");
        video.setRequest_id (request_id);
        video.setChannelID (user_id);
        video.setID (video_id);
        send_request ();
    }

    public void dislike (UUID video_id, UUID user_id, int request_id)
    {
    ...
    public void upload_media (File mediaFile, UUID owner_id, String data_type, String type, int client_handler_id) throws IOException
    {
    ...
    public void send_video_info (UUID owner_id, String title, String description, UUID channel_id, String data_type, int request_id)
    {// data type added
        video.setRequest ("send_video_info");
        video.setRequest_id (request_id);
        video.setChannelID (owner_id);
        video.setTitle (title);
        video.setDescription (description);
        video.setChannelID (channel_id);
        video.setDataType (data_type);
    }

    public void change_channel_photo (UUID channel_id, String data_type, int request_id)
    {
    ...
    public void change_profile_photo (UUID user_id, String data_type, int request_id)
    {
    ...
    public void change_thumbnail (String video_id, int request_id)
    {
    ...
    public void change_playlist_photo (String video_id, int request_id)
    {
